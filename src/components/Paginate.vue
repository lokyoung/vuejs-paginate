<template>
  ...
  <div :class="containerClass" v-else>
    ...
    <template v-for="page in pages">
      ...
      <a v-else @click="handlePageSelected(page.index)" @keyup.enter="handlePageSelected(page.index)" :class="[pageLinkClass, { active: page.selected, disabled: page.disabled }]"
